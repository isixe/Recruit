  ...
  <div id="container">
    <div class="user_bindSidebar">
      <dl id="user_sideBarmenu" class="user_sideBarmenu">
        ...
        <dd><a class="hover" href="userCenter.html">资料修改</a></dd>
        <dd><a class="hover" href="userCenter.html">密码修改</a></dd>
        <dd><a class="hover" href="userCenter.html">用户注销</a></dd>
      </dl>
    </div>
          ...
          <form id="updatePswForm">
            <table class="savePassword">
              ...
              <tr>
                ...
                <td><input type="password" maxlength="16" id="comfirmpassword"
    ...
    <div style="display:none;">
      ...
      <div style="overflow:auto;" class="popup" id="bindTips">
        <table>
          ...
          <tr>
            <td align="center">
              <a id="user_confirmBindTips" class="btn" href="javascript:;">
                <!-- 换个邮箱绑定 -->
              </a>
            ...
            <tr>
              <td class="chooseAccount">
                <label class="">
                  ...
                  <em></em>
                  <div>
                    <div class="f16 c7">保留邮箱：<span value="1" id="user_oldAccount"
                                                   class="c3"></span>帐号下的信息</div>
